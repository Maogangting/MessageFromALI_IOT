...
namespace Aliyun.MNS.Sample
{
    ...
    public class AsyncOperationSample
    {
        ...
        static void ReceiveMessageCallback(IAsyncResult ar)
        {
            ...
            {
                //if ("MessageNotExistException" == ex.GetType().Name)
                //{
                //    fgNotExist = 1;
                //}else {
...
*/
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Begin receive message >>>\n");
            ...
            for (;;)
            {
                ...
                {
                    var nativeQueue = _client.GetNativeQueue(_queueName);
                    BatchReceiveMessageRequest batchReceiveMessageRequest = new BatchReceiveMessageRequest(_batchSize, 3);
